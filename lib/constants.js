module.exports = {
    ...
    REPLY: {
        OFF: Buffer.from([66, 0]),
        WAVE_1: Buffer.from([0, 1]),
        WAVE_2: Buffer.from([0, 2]),
        WAVE_3: Buffer.from([0, 3]),
        WAVE_4: Buffer.from([0, 4]),
        WAVE_5: Buffer.from([0, 15]),
        STROBE: Buffer.from([0, 5]),
        PATTERN: Buffer.from([0, 9]),
    },
